...
# python manage.py generar_fixtures10k | python manage.py cargar_fixtures --fixture-file fixtures_dulceria_10000.json --purge

class Command(BaseCommand):
    help = 'Genera fixtures: 10000 productos, 10000 proveedores, 10000 movimientos (+usuarios/cats/bodegas fijos)'

    def add_arguments(self, parser):
        parser.add_argument(
            '--size',
            type=int,
            default=10000,  # por defecto 10000
    ...
    def handle(self, *args, **options):
        ...
        descripciones = [
            # mismo bloque de 100 descripciones que ya tienes...
